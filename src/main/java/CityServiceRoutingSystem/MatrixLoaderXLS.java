package CityServiceRoutingSystem;
...
public class MatrixLoaderXLS {
    public static void main(String[] args) throws IOException {
        ...
        String filter = "муниципальный округ Академический"; // "Северо-Восточный административный округ", ...

        //OSM data
        String osmFile = "C:/Users/User/Downloads/RU-MOW.osm.pbf";
        String dir = "local/graphhopper";

        String jsonOutputFile1 = "C:\\Users\\User\\Documents\\GD\\academicheskii-park-good.json";
        String jsonOutputFile2 = "C:\\Users\\User\\Documents\\GD\\academicheskii-park-bad.json";
        ...
        if(runAlgo)
        {
            if(doubleMatrix.getMapGood().size()>0) {
                ...
                Result rr = AlgCircularSingleV02.Calculate(
                        doubleMatrix.getWayPointsGood(), doubleMatrix.getMapGood(), maxTime);
            ...
            if(doubleMatrix.getMapBad().size()>0) {
                long startTime = System.currentTimeMillis();
                Result rr = AlgCircularSingleV02.Calculate(
                        doubleMatrix.getWayPointsBad(), doubleMatrix.getMapBad(), maxTime);
                long elapsedTime = System.currentTimeMillis() - startTime;
