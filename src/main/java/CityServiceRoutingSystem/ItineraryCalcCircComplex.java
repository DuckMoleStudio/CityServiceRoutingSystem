...
public class ItineraryCalcCircComplex {
    public static void main(String[] args) {
        ...
        String jsonInputFile = "C:\\Users\\User\\Documents\\GD\\danilovskii-park-good.json"; // should exist!
        ...
        int noOfCars = 7;
        boolean good=true; // good -- with relevant access from right curbside, use for "good" matrix input

        String urlOutputFile = "C:\\Users\\User\\Documents\\GD\\danilovskii-park-good001.txt";
        String outDir ="C:\\Users\\User\\Documents\\GD\\tracks\\danilovskii";
        // ----- CONTROLS END ---------
        ...
        ResultComplex rr = AlgCircularComplexV01.Calculate(wayPointList, matrix, maxTime, noOfCars);
